...
class DetachedHome(AbstractHome):
    ...
    def to_dict(self):
        ...
        detached_home_dict["rooms"] = int(self._number_of_rooms)
        detached_home_dict["bathrooms"] = int(self._number_of_bathrooms)
        detached_home_dict["city"] = str(self._city)
        detached_home_dict["seller"] = str(self._selling_agent)
        detached_home_dict["tax"] = float(self._yearly_property_tax)
        detached_home_dict["floors"] = int(self._number_of_floors)
        detached_home_dict["has_suite"] = bool(self._has_rental_suite)
